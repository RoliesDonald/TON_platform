# T060: Create InventoryItem and Warehouse domain models in backend/internal/domain/inventory.go

**Task ID**: T060
**User Story**: [US4]
**Description**: Create InventoryItem and Warehouse domain models in backend/internal/domain/inventory.go

**File Path**: backend/internal/domain/inventory
