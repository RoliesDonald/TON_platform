# T088: Create Telematics repository in backend/internal/repository/telematics_postgres.go

**Task ID**: T088
**User Story**: [US6]
**Description**: Create Telematics repository in backend/internal/repository/telematics_postgres.go

**File Path**: backend/internal/repository/telematics_postgres
