# T059: Integration test for stock transfer workflow in tests/integration/test_inventory.go

**Task ID**: T059
**User Story**: [US4]
**Description**: Integration test for stock transfer workflow in tests/integration/test_inventory.go

**File Path**: tests/integration/test_inventory
