# T069: Create warehouse selection component in frontend/src/components/WarehouseSelector.tsx

**Task ID**: T069
**User Story**: [US4]
**Description**: Create warehouse selection component in frontend/src/components/WarehouseSelector.tsx

**File Path**: frontend/src/components/WarehouseSelector
...
**Labels**: frontend,enhancement,priority-critical
