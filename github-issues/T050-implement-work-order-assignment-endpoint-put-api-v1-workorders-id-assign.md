# T050: Implement work order assignment endpoint PUT /api/v1/workorders/{id}/assign

**Task ID**: T050
**User Story**: [US3]
**Description**: Implement work order assignment endpoint PUT /api/v1/workorders/{id}/assign
