# T092: Create vehicle status endpoint GET /api/v1/vehicles/{id}/realtime-status

**Task ID**: T092
**User Story**: [US6]
**Description**: Create vehicle status endpoint GET /api/v1/vehicles/{id}/realtime-status
