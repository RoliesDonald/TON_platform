# T074: Create Invoice and Payment domain models in backend/internal/domain/invoice.go

**Task ID**: T074
**User Story**: [US5]
**Description**: Create Invoice and Payment domain models in backend/internal/domain/invoice.go

**File Path**: backend/internal/domain/invoice
