# T078: Create invoice handlers in backend/internal/handler/invoice_handler.go

**Task ID**: T078
**User Story**: [US5]
**Description**: Create invoice handlers in backend/internal/handler/invoice_handler.go

**File Path**: backend/internal/handler/invoice_handler
