# T098: Contract test for mobile API endpoints in tests/contract/test_mobile.go

**Task ID**: T098
**User Story**: [US7]
**Description**: Contract test for mobile API endpoints in tests/contract/test_mobile.go

**File Path**: tests/contract/test_mobile
