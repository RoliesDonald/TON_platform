# T051: Create work order progress update endpoint PUT /api/v1/workorders/{id}/progress

**Task ID**: T051
**User Story**: [US3]
**Description**: Create work order progress update endpoint PUT /api/v1/workorders/{id}/progress
