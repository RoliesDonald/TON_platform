# T037: Implement vehicle status update endpoint PUT /api/v1/vehicles/{id}/status

**Task ID**: T037
**User Story**: [US2]
**Description**: Implement vehicle status update endpoint PUT /api/v1/vehicles/{id}/status
