# T076: Implement InvoiceService in backend/internal/service/invoice_service.go

**Task ID**: T076
**User Story**: [US5]
**Description**: Implement InvoiceService in backend/internal/service/invoice_service.go

**File Path**: backend/internal/service/invoice_service
