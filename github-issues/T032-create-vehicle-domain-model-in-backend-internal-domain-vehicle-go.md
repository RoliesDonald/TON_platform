# T032: Create Vehicle domain model in backend/internal/domain/vehicle.go

**Task ID**: T032
**User Story**: [US2]
**Description**: Create Vehicle domain model in backend/internal/domain/vehicle.go

**File Path**: backend/internal/domain/vehicle
