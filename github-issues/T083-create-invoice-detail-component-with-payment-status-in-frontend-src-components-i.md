# T083: Create invoice detail component with payment status in frontend/src/components/InvoiceDetail.tsx

**Task ID**: T083
**User Story**: [US5]
**Description**: Create invoice detail component with payment status in frontend/src/components/InvoiceDetail.tsx

**File Path**: frontend/src/components/InvoiceDetail
